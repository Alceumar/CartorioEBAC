...
{
	//inicio da criaão de veriáveis/strings
	char arquivo[40];
	char cpf[40];
	char nome[40];
	char sobrenome[40];
	...
	printf("Digite o CPF a ser cadastrado: "); //coletndo informações do usuário 
...
int deletar()
{
	...
	if(file == NULL)
	{
		printf("O usuário não pode se encontra no sistema!.\n");
		system("pause");
	}
